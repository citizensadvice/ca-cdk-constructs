...
def test_non_prod_domain_properties():
    ...
    domain_props = DomainConfiguration(record_name="foo", env_name="qa", apex_domain="somedomain.org.uk")
...
def test_prod_domain_properties():
    ...
    domain_props = DomainConfiguration(record_name="foo", env_name="prod", apex_domain="somedomain.org.uk")
