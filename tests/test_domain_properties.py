...
def test_non_apdex_domain_properties():
    domain_props = DomainProperties(sub_domain="foo", zone_domain="qa.somedomain.org.uk")
...
def test_apdex_domain_properties():
    domain_props = DomainProperties(sub_domain="foo", zone_domain="somedomain.org.uk")
...
def test_apdex_domain_properties_without_subdomain():
    domain_props = DomainProperties(sub_domain="", zone_domain="foo.somedomain.org.uk")
    assert domain_props.domain == "foo.somedomain.org.uk"
    assert domain_props.ingress_domain == "foo-ingress.somedomain.org.uk"
...
def test_repeated_subdomain():
    domain_props = DomainProperties(sub_domain="foo", zone_domain="foo.somedomain.org.uk")
